...
func displayLedger(screens []valuerenderer.Screen, showExpert bool) []string {
	var res []string
	for _, s := range screens {
		...
		// Cut long lines into multiple screens.
		// I'm not 100% sure how ledger does it though.
		kvs := strings.Split(s.Text, ": ")
		var k, v string
		if len(kvs) == 1 {
			v = kvs[0]
		} else {
